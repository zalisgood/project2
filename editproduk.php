...
{
    $kode = $_user_data['kode'];
    $nama = $_user_data['nama'];
    $harju = $_user_data['harga_jual'];
    $harbel = $_user_data['harga_beli'];
    $stok = $_user_data['stok'];
    $minstok = $_user_data['min_stok'];
    $deskripsi = $_user_data['deskripsi'];
    $kategori = $_user_data['kategori_produk_id'];
}
?>
<html>
<head>	
